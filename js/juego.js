...
var Juego = {
    ...
    obstaculosCarretera: [
        ...
        new Obstaculo('imagenes/valla_horizontal.png', 845, 240, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 520, 220, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 804, 450, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 160, 300, 30, 30, 2),
        new Obstaculo('imagenes/bache.png', 320, 400, 30, 30, 2),
        new Obstaculo('imagenes/bache.png', 380, 235, 30, 30, 2),
        new Obstaculo('imagenes/bache.png', 808, 93, 30, 30, 2),
        new Obstaculo('imagenes/bache.png', 763, 489, 30, 30, 2),
        new Obstaculo('imagenes/valla_vertical.png', 170, 440, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 170, 470, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 490, 460, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 600, 115, 30, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 798, 178, 15, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 120, 180, 15, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 100, 150, 15, 30, 1),
    ...
    bordes: [
        // // Bordes
        new Obstaculo('', 0, 5, 961, 18, 1),
        new Obstaculo('', 0, 559, 961, 18, 1),
        new Obstaculo('', 0, 5, 18, 572, 1),
        new Obstaculo('', 943, 5, 18, 572, 1),
        // Veredas
    ...
    enemigos: [
        ...
        new ZombieCaminante('imagenes/zombie2.png', 250, 350, 10, 10, 2, { desdeX: 200, hastaX: 450, desdeY: 400, hastaY: 450 }),
        ...
        new ZombieCaminante('imagenes/zombie4.png', 480, 430, 10, 10, 2, { desdeX: 480, hastaX: 900, desdeY: 430, hastaY: 460 }),
        ...
        new ZombieConductor('imagenes/tren_horizontal.png', 20, 322, 90, 30, 10, { desdeX: 20, hastaX: 850, desdeY: 322, hastaY: 322 }, "h"),
    ],
...
Juego.capturarMovimiento = function(tecla) {
    ...
    if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
        ...
        de sus metodos  */
        if (tecla == 'izq' || tecla == 'arriba' || tecla == 'der' || tecla == 'abajo') {
            Jugador.mover(tecla);
        }
        /* COMPLETAR */
    }
...
Juego.dibujar = function() {
    ...
    //Dibujante dibula LINEA DE PARTIDA.
    Dibujante.dibujarRectangulo("white", 127, 64, 21, 2);
    Dibujante.dibujarRectangulo("white", 127, 62, 2, 2);
    Dibujante.dibujarRectangulo("white", 127, 60, 2, 2);
    Dibujante.dibujarRectangulo("white", 146, 62, 2, 2);
    Dibujante.dibujarRectangulo("white", 146, 60, 2, 2);

    //Dibujante dibuja LINEA DE LLEGADA!
